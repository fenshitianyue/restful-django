...
if __name__ == '__main__':
    ...
    # print sql
    sql = "select field1, field2, count(field3), avg(field4) from table1 where field1='value1' and field2 > 5 and field3 like 'substr1' group by field1, field2 order by field1, field2 desc limit 2000"
